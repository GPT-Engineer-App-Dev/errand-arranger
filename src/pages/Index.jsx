      ...
      <List spacing={3}>
        {tasks.map((task) => (
          <ListItem key={task.id} p={2} bg={task.isCompleted ? "green.100" : "gray.100"}>
            ...
            <IconButton icon={<FaCheck />} aria-label="Complete Task" colorScheme="green" size="sm" ml={2} onClick={() => handleToggleTaskCompletion(task.id)} isDisabled={task.isCompleted} />
